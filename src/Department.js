...
FilterFn() {
    ...
    // Updating the state with filtered data
    this.setState({ departments: filteredData });
}

// Function to sort the department list
sortResult(prop, asc) {
    ...
    // Updating the state with sorted data
    this.setState({ departments: sortedData });
}

// Event handler for changing DepartmentId filter
changeDepartmentIdFilter = (e) => {
    this.state.DepartmentIdFilter = e.target.value;
    this.FilterFn();
};

// Event handler for changing DepartmentName filter
...
// Lifecycle method: triggered after component is mounted
componentDidMount() {
    // Fetching and displaying the initial list of departments
    this.refreshList();
}

// Event handler for changing DepartmentName
changeDepartmentName = (e) => {
    this.setState({ DepartmentName: e.target.value });
};

// Event handler for 'Add Department' button click
addClick() {
    this.setState({
...
// Event handler for 'Edit Department' button click
editClick(dep) {
    this.setState({
...
createClick() {
    fetch(variables.API_URL + "department", {
        ...
        .then(
            (result) => {
                // Displaying the result and refreshing the department list
                alert(result);
                this.refreshList();
            },
            (error) => {
